...
const processNode = (node, parent) => {
  return new Promise(async (resolve, reject) => {
    try {
      ...
      const encodedSampleCode = encodeURIComponent(`/*
 * This demo is using pre-compiled styles, not all styles/features may be available.
 * Please see the compilation docs to setup your environment for production.
 *
 * In this example, the styles are compiled as:
